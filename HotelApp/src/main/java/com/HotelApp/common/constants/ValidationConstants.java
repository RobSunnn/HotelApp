...
public class ValidationConstants {
    ...
    public static final String FIRST_AND_LAST_NAME_LENGTH_TOO_LONG = "Your name is too long.";
    ...
    public static final String INVALID_AGE_OVER_100 = "You exceed the maximum value for age.";

    public static final String NEGATIVE_AGE = "Your age cannot be negative :D";

    public static final String MINIMUM_AGE = "You need to be over 18 years old!";
    ...
    public static final String CONFIRM_PASSWORD = "You need to confirm your password!";

    public static final String OLD_PASS_MISMATCH = "Old password mismatch.";
