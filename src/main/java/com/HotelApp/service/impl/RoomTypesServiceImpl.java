...
public class RoomTypesServiceImpl implements RoomTypesService {
    ...
    public Page<RoomTypeView> getRoomTypes(Pageable pageable) {
        return roomTypeRepository.findAll(pageable)
                .map(RoomTypesServiceImpl::mapToView);
    }

    private static RoomTypeView mapToView(RoomTypeEntity roomTypeEntity) {
    ...
    public void initRoomTypes() {
        ...
        roomTypeRepository.save(
                new RoomTypeEntity("Single Room",
        ...
        roomTypeRepository.save(
                new RoomTypeEntity("Double Room",
        ...
        roomTypeRepository.save(
                new RoomTypeEntity("Deluxe Room",
        ...
        roomTypeRepository.save(
                new RoomTypeEntity("Presidential Room",
    ...
    public void getRooms(Pageable pageable, Model model) {
        ...
        Page<RoomTypeView> lastPage = getRoomTypes(
                PageRequest.of(totalPages - 1, pageable.getPageSize(), pageable.getSort())
        );
